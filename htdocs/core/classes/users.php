<?php
	class Users {
		...
		public function userdata($id) {
			...
			$query = $this->db->prepare("SELECT designers.firstname, designers.lastname, designers.email FROM " . DB_NAME . ".designers WHERE `id`= ?
				UNION SELECT developers.firstname, developers.lastname, developers.email FROM " . DB_NAME . ".developers WHERE `id`= ?
				UNION SELECT employers.firstname, employers.lastname, employers.email FROM " . DB_NAME . ".employers WHERE `id`= ?
				");
